...
public class GeminiService {
    ...
    private String buildResumePrompt(User user) {
        ...
        return String.format("""
                        ...
                        4. 말투: '~합니다'의 정중한 어조.
                        5. 금지: 마크다운 기호(###, **) 사용 금지. 순수 텍스트만 출력.
                        6. 반복금지: 불필요한 수식어나 반복되는 표현을 제거하고 핵심 위주로 서술할 것.
                        7. 구성: 전체 문장을 5~6문장 내외로 구성하면 글자 수를 맞추기 용이합니다.
                        
                        [제약 사항]
                        1. 분량 엄수: 반드시 공백 포함 최대 480자 이내로 작성할 것 (500자를 절대 넘기지 말 것).
                        """,
